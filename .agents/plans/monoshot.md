...
**PR 4 — `feat(app): editing`.** CM6 replaces the static render: editor assembly, shiki token bridge, CM6 theme from `Theme.derive`, shared text metrics, language auto-detect, in-memory store wiring controls.
